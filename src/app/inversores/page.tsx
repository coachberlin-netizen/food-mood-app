          ...
          <div style={{ background: '#FAFAF7', border: '1px solid #E0EDE6', borderTop: 'none', borderRadius: '0 0 4px 4px', padding: '18px 20px' }}>
            ...
            <div style={{ background: '#F0EDE4', border: '1px solid #E0EDE6', borderLeft: '3px solid #3A8C62', borderRadius: '0 4px 4px 0', padding: '12px 14px', marginTop: 16 }}>
              ...
              <p style={{ fontSize: 9.5, color: '#2A2218', lineHeight: 1.65, marginBottom: 6 }}>
                The AI is grounded in a proprietary, curated knowledge base: <strong style={{ color: '#1A1612' }}>15 specialist documents, 282 vectorised fragments</strong> covering the gut-brain axis (Cryan, Dinan, Mayer), psychobiotics, chrononutrition (Panda), psiconeuroinmunología, constructed emotion theory (Feldman Barrett), perimenopause (Briden) and menopause (Haver). Built from scientific literature, founder-authored frameworks and structured evidence tiers — not trained on commercial books or generic wellness content.
              </p>
...
— 24 newsletter editions published; proprietary RAG knowledge base: 15 specialist documents, 282 vectorised fragments covering gut-brain axis, psychobiotics, chrononutrition, constructed emotion, PNI, perimenopause and menopause

        ...
        <details style={{ marginTop: 16, marginBottom: 4 }}>
          ...
          <div style={{ background: '#FAFAF7', border: '1px solid #E0EDE6', borderTop: 'none', borderRadius: '0 0 4px 4px', padding: '18px 20px' }}>
            ...
            {([
              ...
              ['Plant diversity tracker (Spector framework)', 'A weekly counter of distinct plant species consumed — vegetables, fruits, legumes, nuts, seeds, herbs, spices. Inspired by the Zoe/PREDICT research showing that 30+ plant varieties per week is the strongest single predictor of microbiome diversity. Unlike calorie counters, it only adds; it never restricts. Gamified as collection rather than accounting — each new herb, each new apple variety counts. The anti-calorie-counter.'],
          ...
          <div style={{ background: '#FAFAF7', border: '1px solid #E0EDE6', borderTop: 'none', borderRadius: '0 0 4px 4px', padding: '18px 20px' }}>
            ...
            <div style={{ background: '#F0EDE4', border: '1px solid #E0EDE6', borderLeft: '3px solid #3A8C62', borderRadius: '0 4px 4px 0', padding: '12px 14px', marginTop: 16 }}>
              ...
              <p style={{ fontSize: 9.5, color: '#2A2218', lineHeight: 1.65, marginBottom: 6 }}>
                The AI is grounded in a proprietary, curated knowledge base: <strong style={{ color: '#1A1612' }}>15 specialist documents, 282 vectorised fragments</strong> covering the gut-brain axis (Cryan, Dinan, Mayer), psychobiotics, enterochromaffin serotonin synthesis (Yano 2015), chrononutrition (Panda), psiconeuroinmunología, constructed emotion theory (Feldman Barrett), perimenopause (Briden), menopause (Haver), intuitive eating / anti-diet framework (Tribole-Resch) and clinical longevity / Medicine 3.0 (Attia). Built from scientific literature, founder-authored frameworks and structured evidence tiers — not trained on commercial books or generic wellness content.
              </p>
...
— 24 newsletter editions published; proprietary RAG knowledge base: 15 specialist documents, 282 vectorised fragments covering gut-brain axis, psychobiotics, enterochromaffin serotonin, chrononutrition, constructed emotion, PNI, perimenopause, menopause, intuitive eating and clinical longevity (Medicine 3.0)
...
const BULLETS: Array<{ label: string; items: string[] }> = [
  ...
  },
  {
    ...
    items: [
      'Active newsletter + WhatsApp & Telegram communities — warm audience primed for launch',
      'Demand validated through founder coaching practice (Umyko wellness community, paying clients)',
      '24 newsletter editions published; proprietary RAG knowledge base: 15 specialist documents, 282 vectorised fragments (gut-brain axis, psychobiotics, chrononutrition, perimenopause, menopause, constructed emotion, PNI)',
    ],
  },
  {

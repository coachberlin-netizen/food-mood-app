    ...
    <div className="min-h-screen bg-[#FDFBF7]">
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <header className="flex flex-col gap-6 mb-16 md:mb-20">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-5xl font-serif text-[#1B2A49] leading-tight">
        ...
        <main className="flex flex-col gap-14 md:gap-16">
          ...
          <section className="flex flex-col gap-4">
            <h2 className="text-2xl font-serif text-[#1B2A49] flex items-baseline gap-3">
        ...
        <div className="mt-20 pt-10 border-t border-[#1B2A49]/10 text-center">

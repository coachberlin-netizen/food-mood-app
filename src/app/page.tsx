          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            {([
              ...
              },
              {
                ...
                price: "9€",
                cadence: "/mes",
                features: ["200+ recetas completas", "Paleta emocional personalizada", "Historial de 90 días", "Glosario científico"],
              ...
              },
              {
                ...
                features: ["Todo lo del plan mensual", "Ahorra un 44%", "Fermentos del Mundo", "Cancela cuando quieras"],
                cta: "Mejor precio →",
                href: "/pricing",
                highlight: true,
              },

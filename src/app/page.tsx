...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#F5F0E8] overflow-hidden font-sans font-light">
      ...
      {/* ── 0. FOOD·MOOD IA — primera sección ──────────────────────────────── */}
      <section aria-label="FOOD·MOOD IA — Asistente premium" className="py-14 md:py-20 px-6" style={{ backgroundColor: "#2d0f16" }}>
        <div className="max-w-5xl mx-auto">

          {/* Header de sección */}
          <div className="flex items-center gap-3 mb-10">
            <div className="w-9 h-9 rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "rgba(201,168,76,0.12)", border: "1px solid rgba(201,168,76,0.22)" }}>
              <Sparkles className="w-4 h-4" style={{ color: "#C9A84C" }} />
            </div>
            <div>
              <p className="text-[9px] font-bold uppercase tracking-[0.35em]" style={{ color: "rgba(201,168,76,0.55)" }}>Asistente IA · Solo premium</p>
              <p className="text-sm font-semibold" style={{ color: "rgba(245,240,232,0.85)" }}>FOOD·MOOD IA</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-start mb-10">
            ...
            {/* Título + descripción + pills */}
            <div className="space-y-6">
              <h2 className="font-serif text-3xl md:text-4xl text-white leading-[1.15]">
                FOOD-MOOD Guide.
                <br />
            ...
            {/* Chat preview — a la derecha de las features */}
            <div className="relative rounded-2xl overflow-hidden p-5 space-y-3" style={{ backgroundColor: "#F5F0E8", border: "1px solid rgba(201,168,76,0.15)" }}>
              ...
              {[
                ...
                { role: "assistant", text: "Tiene sentido que la ansiedad te descoloque el hambre — es uno de los primeros sistemas que se activan cuando el eje intestino-cerebro está bajo carga. ¿El impulso aparece más antes de comer, durante o después?" },

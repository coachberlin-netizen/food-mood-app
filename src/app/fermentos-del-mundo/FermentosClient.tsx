...
// Proyección súper abstracta equirectangular para % de contenedor
function getPosition(lat: number, lng: number) {
  // Ajuste fino para un mapa de proporciones 2:1 (ej. viewBox 0 0 1000 500)
  const x = ((lng + 180) / 360) * 100;
  // Latitud necesita un factor de compresión porque la tierra no es plana.
  // Mercator aproximado o lineal con offset visual:
  const y = ((90 - lat) / 180) * 100;
  
  return { left: `${x}%`, top: `${y}%` };
}

// Un SVG extremadamente simplificado y abstracto del mundo
const WorldAbstractSVG = () => (
  <svg viewBox="0 0 1000 500" className="w-full h-full text-aubergine-dark/5" fill="currentColor">
    {/* Aproximaciones de formas gruesas para continentes, para dar sensación premium minimalista sin path pesado */}
    {/* Norteamérica */}
...
export default function FermentosClient({ 
  ...
  return (
    <div className="w-full relative">
        ...
        {initialFerments.map((ferment) => {
          ...
          return (
            <motion.div
              ...
              onClick={() => handleFermentClick(ferment.slug)}
            >
              {/* Pin Base + Pulso */}
      ...
      {/* ── GRID INFERIOR (Mobile & Alternative mapping) ── */}
             ...
             return (
              ...
              >
                ...
                <div className="mt-auto pt-4 w-full border-t border-aubergine-dark/5 flex items-center justify-between">
                   <span 
                     className="text-[9px] uppercase tracking-widest font-bold px-2 py-1 rounded-sm text-aubergine-dark/80"
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-cream/60 font-light text-base leading-relaxed mb-8">
                Desbloquea 16 fermentos ancestrales, sus recetas y la ciencia detrás de cada cultivo vivo. Tu microbiota merece la mejor inspiración del planeta.
              </p>

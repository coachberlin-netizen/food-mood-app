...
const biblioteca: Seccion[] = [
  ...
  {
    categoria: 'Nutrición Personalizada y Variabilidad Interpersonal',
    descripcion: 'Por qué la misma dieta no funciona para todos — el estudio PREDICT y el marco Spector.',
    items: [
      {
        autores: 'Berry, S.E., et al.',
        ano: 2020,
        titulo: 'Human postprandial responses to food and potential for precision nutrition',
        revista: 'Nature Medicine',
        volumen: '26',
        paginas: '964–973',
        doi: '10.1038/s41591-020-0934-0',
        url: 'https://doi.org/10.1038/s41591-020-0934-0',
        relevancia: 'PREDICT-1: más de 1.000 personas, CGM 14 días. La misma comida produce picos glucémicos hasta 10× mayores entre individuos. Microbiota, sueño y ejercicio previo predicen la respuesta mejor que la genética. Base científica de la personalización nutricional.',
        usadoEn: ['KB Spector', 'Asesor Personal', 'Home'],
      },
      {
        autores: 'Spector, T.',
        ano: 2022,
        titulo: 'Food for Life: The New Science of Eating Well',
        revista: 'Jonathan Cape',
        isbn: '978-1787334106',
        url: 'https://www.timspector.com/books/',
        relevancia: 'Síntesis del marco Spector: 30+ plantas/semana, UPFs como problema central, fermentos diarios, timing, variabilidad interpersonal. Manual operativo del agente para personalización nutricional sin dogma.',
        usadoEn: ['KB Spector', 'Asesor Personal'],
      },
      {
        autores: 'Spector, T.',
        ano: 2020,
        titulo: 'Spoon-Fed: Why Almost Everything We\'ve Been Told About Food Is Wrong',
        revista: 'Jonathan Cape',
        isbn: '978-0224092265',
        url: 'https://www.timspector.com/books/',
        relevancia: 'Desmonta 20 mitos nutricionales heredados con evidencia actual. Fuente del listado de mitos que el agente puede corregir con calidez cuando el usuario los traiga.',
        usadoEn: ['KB Spector', 'Asesor Personal'],
      },
      {
        autores: 'Hall, K.D., et al.',
        ano: 2019,
        ...
        relevancia: 'Ensayo controlado en régimen de internamiento (NIH): dieta UPF ad libitum → +500 kcal/día vs dieta no procesada. El exceso no es de voluntad; los UPFs alteran señales de saciedad y microbiota. Prueba definitiva de que UPF ≠ alimento real.',
        usadoEn: ['KB Spector', 'Asesor Personal'],
      },
      {
        autores: 'Wastyk, H.C., et al.',
        ano: 2021,
        ...
        relevancia: 'Sonnenburg-Gardner (Stanford): dieta alta en fermentos durante 10 semanas → diversidad microbiana ↑ + inflamación ↓. Dieta alta en fibra sola no lo logró en el mismo plazo. Base de "fermentos diarios + fibra variada" como patrón óptimo.',
        usadoEn: ['KB Spector', 'KB microbiota', 'Asesor Personal'],
      },
    ],
  },
  {

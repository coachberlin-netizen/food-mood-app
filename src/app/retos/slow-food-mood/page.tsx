...
const REFERENCES = [
  ...
  },
  {
    ...
    insight: 'El protocolo MBSR demuestra que la atención plena en actividades cotidianas reduce el estrés crónico con efectos duraderos años después.',
  },
  {
  ...
  },
  {
    ...
    source: 'Journal of Functional Foods · pubmed.ncbi.nlm.nih.gov/38278378',
  ...
  },
  {
    ...
    source: 'Nutritional Neuroscience · pubmed.ncbi.nlm.nih.gov/30415609',
          ...
          <div className="space-y-4">
            {REFERENCES.map((ref, i) => (
              <article
                ...
                style={{ background: 'white', borderColor: 'rgba(107,39,55,0.08)' }}
              >
                <p className="text-xs font-semibold mb-0.5" style={{ color: '#6B2737' }}>{ref.author}</p>
                <p className="text-sm font-medium mb-1 leading-snug" style={{ color: '#2d0f16' }}>{ref.title}</p>
                <p className="text-[11px] font-light mb-2" style={{ color: 'rgba(107,39,55,0.45)' }}>{ref.source}</p>
                <p className="text-xs font-light leading-relaxed" style={{ color: 'rgba(107,39,55,0.65)' }}>
                  → {ref.insight}
                </p>
              </article>
            ))}

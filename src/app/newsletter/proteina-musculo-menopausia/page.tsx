...
export const metadata: Metadata = {
  ...
  keywords: 'sarcopenia menopausia, proteína menopausia, leucina músculo, resistencia anabólica, proteína 45+, músculo estrógenos, desayuno proteico menopausia, mTOR leucina',

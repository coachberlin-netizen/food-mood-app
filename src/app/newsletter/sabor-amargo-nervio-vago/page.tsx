...
export const metadata: Metadata = {
  ...
  keywords: 'sabor amargo nervio vago, receptores TAS2R, café amargo cortisol, rúcula nervio vago, regulación emocional alimentos, achicoria ansiedad, vinagre kombucha microbiota, cúrcuma sistema nervioso, jengibre vagal, alimentación y emociones',

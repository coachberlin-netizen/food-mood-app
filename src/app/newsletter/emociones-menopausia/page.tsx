...
export const metadata: Metadata = {
  ...
  keywords: 'menopausia serotonina, comer emocional menopausia, estrógenos humor, patrones emocionales alimentarios, nutrientes menopausia, triptófano menopausia, omega-3 menopausia, magnesio menopausia, antojos menopausia, hambre emocional',

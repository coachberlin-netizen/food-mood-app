...
export const metadata: Metadata = {
  ...
  keywords: 'espectro emocional, interocepción y emociones, eje intestino-cerebro emociones, granularidad emocional, GABA serotonina alimentos, kéfir ansiedad, microbiota y estado de ánimo, emociones complejas mujer, neurociencia emocional, alimentación y humor',

...
export const metadata: Metadata = {
  title: 'Tu tiroides no estÃ¡ rota. QuizÃ¡ solo tiene frÃ­o. | FoodÂ·Mood Newsletter NÂº 17',
  description:
    'Hipotiroidismo subclÃ­nico en postmenopausia: selenio, yodo, zinc, vitamina A y omega-3. Los 5 nutrientes que la tiroides necesita y los alimentos que los aportan. Newsletter NÂº 17 de FoodÂ·Mood, serie Equilibrio Hormonal 45+.',
  alternates: { canonical: 'https://www.food-mood.app/newsletter/tiroides-postmenopausia' },
  openGraph: {
    title:         'Tu tiroides no estÃ¡ rota. QuizÃ¡ solo tiene frÃ­o.',
    description:   'El hipotiroidismo subclÃ­nico afecta al 15-20% de las mujeres en postmenopausia. Selenio, yodo, zinc y omega-3: los nutrientes concretos que marcan una diferencia real.',
    url:           'https://www.food-mood.app/newsletter/tiroides-postmenopausia',
    type:          'article',
    siteName:      'FoodÂ·Mood',
    publishedTime: '2026-05-11',
    images:        [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Newsletter FoodÂ·Mood â€” Tiroides y postmenopausia' }],
  },
  twitter: {
    card:        'summary_large_image',
    title:       'Tu tiroides no estÃ¡ rota. QuizÃ¡ solo tiene frÃ­o.',
    description: '2 nueces de Brasil al dÃ­a para el selenio. Sardinas para selenio + omega-3 + yodo. Semillas de calabaza para el zinc. La tiroides en postmenopausia y la nutriciÃ³n que funciona. Newsletter NÂº 17.',
    images:      ['/og-image.png'],
  },
}
...
const LD = {
  ...
  '@graph': [
    {
      '@type':          'NewsArticle',
      headline:         'Tu tiroides no estÃ¡ rota. QuizÃ¡ solo tiene frÃ­o.',
      description:      'Hipotiroidismo subclÃ­nico en postmenopausia: selenio, yodo, zinc, vitamina A y omega-3. Los nutrientes que la tiroides necesita y los alimentos que los aportan.',
      url:              'https://www.food-mood.app/newsletter/tiroides-postmenopausia',

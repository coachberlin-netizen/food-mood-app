...
export const SYMPTOMS: SymptomDefinition[] = [
  ...
  },
  {
    ...
    explicacion_cientifica: 'Tu arquitectura del sueño depende de la conversión eficiente de triptófano en serotonina y, al caer el sol, en melatonina. Una inflamación sistémica leve compite activamente por ese triptófano, desviándolo hacia vías metabólicas proinflamatorias (quinurenina) en lugar de neuromoduladoras. Las cenas hipercalóricas, ricas en azúcares simples, elevan la temperatura core y mantienen el cortisol alto, impidiendo que el GABA —tu principal freno cerebral— pueda inducir el sueño reparador profundo. La microbiota también regula directamente el ciclo circadiano a través del nervio vago.',
    mood_es: 'Calma',

...
export const recipesData: Recipe[] = [
  // ACTIVACION
  {
    ...
    ingredients: [
      ...
      { name: "Kombucha original (vinagre de kombucha o de manzana cruda)", quantity: "30ml" },
    ...
    steps: [
      ...
      "Vierte orgánicamente la kombucha viva (vinagre de kombucha o de manzana cruda).",
  ...
  },
  {
    id: "r2",
    moodId: "activacion",
    title: "Ensalada Cítrica con Vinagreta de vinagre de kombucha o de manzana cruda",
    title_en: "Citrus Salad with vinagre de kombucha o de manzana cruda Vinaigrette",
    ...
    ingredients: [
      ...
      { name: "Vinagre de kombucha o de manzana cruda", quantity: "1 cda" },
    ...
    steps: [
      ...
      "En un bol pequeño, emulsiona el AOVE con el vinagre de kombucha o de manzana cruda y sal en escamas.",

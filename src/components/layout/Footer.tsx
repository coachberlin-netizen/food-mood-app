    ...
    <footer className="w-full bg-aubergine-dark py-16">
      <div className="container mx-auto px-6 md:px-12 flex flex-col items-center justify-center space-y-8">
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-[11px] font-light text-white/75 tracking-wide">food-mood.app · © 2026</span>
        </div>
        <div className="w-full flex flex-col items-center space-y-4 mb-8">
          <p className="text-sm font-light text-white/80">Únete al Newsletter para un consejo semanal</p>
          <NewsletterForm source="footer" dark={true} />
        </div>
        <div className="flex flex-col items-center space-y-4 pt-8 border-t border-white/10 w-full max-w-3xl">
          <p className="text-[13px] font-light text-white/75 text-center leading-relaxed px-4">
          ...
          <p className="text-[11px] font-light text-white/75 text-center leading-relaxed px-4 mt-2 max-w-2xl">
          ...
          <div className="pt-12 pb-8 grid grid-cols-1 md:grid-cols-2 gap-8 w-full border-b border-white/10">
            <div className="flex flex-col items-center md:items-start space-y-2">
              <span className="text-[10px] uppercase tracking-[0.2em] text-white/60 font-bold">Saber más</span>
              <Link href="/saber-mas" className="text-sm text-white/80 hover:text-gold transition-colors">
                Dudas, transparencia y bienestar
              </Link>
            </div>
            <div className="flex flex-col items-center md:items-end space-y-2">
              <span className="text-[10px] uppercase tracking-[0.2em] text-white/60 font-bold">Fermentos del Mundo</span>
              <Link href="/fermentos-del-mundo" className="text-sm text-white/80 hover:text-gold transition-colors">
                Explora nuestro mapa interactivo
              </Link>
            </div>
          </div>

          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 text-[11px] tracking-[0.2em] uppercase text-white/75 pt-8 px-4">
            ...
            <span className="opacity-10 hidden sm:inline">|</span>
            <Link href="/aviso-legal" className="hover:text-gold transition-colors duration-300">
              Aviso Legal
            </Link>
          </div>
        </div>

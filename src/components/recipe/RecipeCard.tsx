...
export function RecipeCard({ recipe }: { recipe: Recipe }) {
  ...
  const imagePlaceholderMap: Record<string, string> = {
    ...
    "confort": "https://hbiraafgjshhyjhpbqty.supabase.co/storage/v1/object/sign/placeholders/generated-image%20(62).png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV83ZTQxY2E0Yi1hYWIyLTQ4NDctOTBiMi0zZjY4M2EzOTExMzQiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJwbGFjZWhvbGRlcnMvZ2VuZXJhdGVkLWltYWdlICg2MikucG5nIiwiaWF0IjoxNzc0ODAxODMwLCJleHAiOjE4MDYzMzc4MzB9.MR8uBTrTeV1W1hU0t5sXNz4qcxyT0zuDnoacK5g7OH4"
  };

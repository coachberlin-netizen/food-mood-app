...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .fb-mood{display:inline-block;font-size:10px;font-weight:500;letter-spacing:.1em;text-transform:uppercase;padding:3px 10px;border-radius:20px;background:rgba(255,107,53,0.15);color:#FF6B35;margin-left:auto;flex-shrink:0}
  ...
  .rs-label{font-size:10px;font-weight:500;text-transform:uppercase;letter-spacing:.12em;color:#FF6B35;margin-bottom:10px}

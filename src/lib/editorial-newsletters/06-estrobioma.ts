...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .cta-btn{display:inline-block;background:#C9A84C;color:#1A0E2E;font-size:15px;font-weight:600;padding:15px 32px;border-radius:30px;text-decoration:none;letter-spacing:.02em}

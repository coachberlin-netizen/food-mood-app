...
<div class="wrapper">
  ...
  <div class="intro">
    ...
    <div class="intro-body">
      <p>Eso no es pereza. No es estrés mal gestionado. No es que necesites vacaciones.
        Es que <strong>tus mitocondrias no están recibiendo lo que necesitan para producir energía de forma eficiente.</strong></p>
      <p>Las mitocondrias son las centrales energéticas de cada célula. Convierten lo que comes en ATP —
        la molécula de energía que usa todo el cuerpo, desde el músculo hasta el cerebro.
        Cuando ese proceso falla, la fatiga aparece antes de que nada más lo haga.</p>
      <p>La buena noticia: las mitocondrias responden rápido. Con los cofactores correctos,
        la producción de ATP mejora en días. <strong>No en meses. En días.</strong></p>
    </div>
  </div>
  <div class="pullquote">
  ...
  <div class="ciencia">
    ...
    <div class="ciencia-body">
      <p>La Coenzima Q10 — CoQ10, ubiquinona — es la molécula central de la cadena de transporte
        electrónico mitocondrial. Actúa como lanzadera de electrones entre los complejos I-II y III,
        el proceso que convierte los nutrientes en ATP.</p>
      <p>Sin CoQ10 suficiente, la cadena respiratoria pierde eficiencia: se produce menos ATP
        ...
        niebla mental de fondo.</strong></p>
    </div>
    <div class="cadena">
    ...
    <div class="ciencia-body" style="margin-top:16px;">
      <p>Estos tres cofactores — CoQ10, magnesio y omega-3 — son los más frecuentemente
        deficientes en personas con fatiga crónica. Y los tres se pueden recuperar
        <strong>en días, no en meses, cuando se aportan desde la alimentación.</strong></p>
    </div>
  </div>
      ...
      <div class="receta-body">
        ...
        <div class="receta-pasos">
          ...
          <div class="paso">
            ...
            <div>Extiende la rúcula o espinacas en el bol.
              <span class="paso-tip">Las espinacas aportan magnesio adicional — el cofactor del ATP activo.</span>
            </div>
          </div>
          <div class="paso">
            <div class="paso-num">2</div>
            <div>Desmenuza las sardinas encima. Si el aceite de la lata es de oliva, viértelo también.
          ...
          <div class="paso">
            ...
            <div>Aliña con zumo de limón, aceite de oliva, sal y pimienta.
              Unas gotas de vinagre de kombucha o de manzana al final si tienes.
            </div>
          </div>
        </div>
  ...
  <div class="cierre">
    <p class="cierre-text">
      ...
      Cuando los aportas, las mitocondrias responden. Rápido.<br><br>

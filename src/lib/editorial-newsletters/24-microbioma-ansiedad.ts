...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .g1-bacteria-block { border-bottom: 1px solid rgba(201,168,76,0.10); padding: 14px 14px 14px; }
  .g1-bacteria-block:last-child { border-bottom: none; }
  .g1-bacteria-name { color: #C9A84C; font-weight: 700; font-size: 12px; margin-bottom: 6px; font-style: italic; }
  .g1-bacteria-body { font-size: 11px; font-weight: 300; line-height: 1.60; color: rgba(245,240,232,0.70); }
  .g1-bacteria-cite { font-size: 10px; color: rgba(201,168,76,0.45); font-style: italic; margin-top: 5px; }
  .g1-note { margin-top: 16px; font-size: 10.5px; font-style: italic; color: rgba(201,168,76,0.40); line-height: 1.65; }
  ...
  .cycle-node-label { font-size: 10px; font-weight: 700; letter-spacing: .12em; text-transform: uppercase; color: rgba(201,168,76,0.50); margin-bottom: 4px; }
  .cycle-node-text { font-size: 12.5px; font-weight: 300; line-height: 1.55; color: rgba(245,240,232,0.82); }
  .cycle-node-text strong { color: #C9A84C; font-weight: 700; }
  ...
  .destroy-title { font-family: 'Playfair Display', Georgia, serif; font-size: 16px; font-weight: 700; color: #C9A84C; margin-bottom: 8px; }

...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .header::after{content:'';position:absolute;bottom:-20px;left:-20px;width:160px;height:160px;border-radius:50%;background:rgba(201,168,76,0.08)}
  ...
  .ca{font-size:14px;color:#C9A84C;padding:0 4px;flex-shrink:0}
  ...
  .cta-check{color:#C9A84C;font-weight:700;flex-shrink:0}
  .cta-btn{display:inline-block;background:#C9A84C;color:#1A0E1A;font-size:15px;font-weight:600;padding:15px 32px;border-radius:30px;text-decoration:none;letter-spacing:.02em}
...
<div class="wrapper">
  ...
  <div class="cta-reto">
    ...
    <a href="https://www.food-mood.app/retos/equilibrio-hormonal-45" class="cta-btn">Empezar el reto ahora →</a>

...
<div class="wrapper">
  ...
  <div class="cta-reto">
    ...
    <p class="cta-reto-desc">
      Reset mitocondrial completo. 7 días con recetas, audios y seguimiento real
      de tu índice Food·Mood. Resultados medibles antes de terminar la semana.
    </p>
    <div class="cta-incluye">
      ...
      <div class="cta-incluye-item"><span class="cta-incluye-check">✓</span> Informe personalizado al completar</div>

/**
 * Envía la newsletter Nº 24 a todos los suscriptores.
 * Uso: npx tsx scripts/send-newsletter-24-all.ts
 */
...
import { buildHtml } from '../src/lib/editorial-newsletters/24-microbioma-ansiedad'

const SUBJECT = 'Tu ansiedad tiene 38 billones de cómplices. Se llaman bacterias intestinales.'
...
async function main() {
  ...
  console.log(`\nEnviando newsletter Nº 24 a ${emails.length} suscriptores\n`)

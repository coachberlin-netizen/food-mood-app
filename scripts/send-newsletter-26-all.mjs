...
const html    = readFileSync('newsletters/26-telomeros-longevidad.html', 'utf8')
const FROM    = 'Food·Mood <hola@food-mood.app>'
const SUBJECT = '[Nº26] Tus células tienen memoria. Y la alimentación puede cambiar su historia.'
const DELAY   = 1500
...
console.log(`\n📬 Enviando newsletter Nº 26 a ${emails.length} suscriptores\n`)
